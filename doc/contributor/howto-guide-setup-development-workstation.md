# How-to Guide: Setup a Development Workstation (or VM)

This document explains how to setup a workstation (or VM) for development **of**
`google-cloud-cpp`. That is, this document's intended audience are
`google-cloud-cpp` contributors.
