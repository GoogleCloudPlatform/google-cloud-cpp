...
struct PersistentState {
  ...
  static StatusOr<PersistentState> FromString(std::string const& json_rep);
...
class ParallelUploadStateImpl
 ...
 public:
  ...
  PersistentState ToPersistentState() const;
...
StatusOr<ResumableParallelUploadState> ResumableParallelUploadState::Resume(
  ...
  auto persistent_state = PersistentState::FromString(state_string);
  if (!persistent_state) {
