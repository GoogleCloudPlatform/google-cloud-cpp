...
TEST(AsyncRetryLoopTest, Success) {
  ...
  StatusOr<int> actual =
      AsyncRetryLoop(
          TestRetryPolicy(), TestBackoffPolicy(), IsIdempotent::kIdempotent,
          background.cq(),
...
TEST(AsyncRetryLoopTest, ReturnJustStatus) {
  ...
  Status actual = AsyncRetryLoop(
                      ...
                      IsIdempotent::kIdempotent, background.cq(),
                      [&](google::cloud::CompletionQueue&,
...
TEST(AsyncRetryLoopTest, UsesBackoffPolicy) {
  ...
  StatusOr<int> actual =
      AsyncRetryLoop(
          TestRetryPolicy(), std::move(mock), IsIdempotent::kIdempotent,
          background.cq(),
          [&](google::cloud::CompletionQueue&,
              std::unique_ptr<grpc::ClientContext>, int request) {
            if (++counter <= 3) {
...
TEST(AsyncRetryLoopTest, TransientFailureNonIdempotent) {
  ...
  StatusOr<int> actual =
      AsyncRetryLoop(
          TestRetryPolicy(), TestBackoffPolicy(), IsIdempotent::kNonIdempotent,
          background.cq(),
          [](google::cloud::CompletionQueue&,
             std::unique_ptr<grpc::ClientContext>, int) {
