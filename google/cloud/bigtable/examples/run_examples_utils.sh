...
function run_all_data_async_examples {
  ...
  run_example ./data_async_snippets async-read-rows "${project_id}" "${instance_id}" "${TABLE}"
  run_example ./data_async_snippets async-read-rows-with-limit "${project_id}" "${instance_id}" "${TABLE}"
