...
/**
 * Create a randome prefix for object names.
 *
...
/**
 * Create a "marker" object to ensure that two functions cannot share a prefix.
 *
 ...
 *     should not be any objects with this prefix; in order to acoid rece
