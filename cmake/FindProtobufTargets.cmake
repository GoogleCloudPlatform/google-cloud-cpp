...
if (protobuf_DEBUG)
    ...
    if (ProtobufTargets_FOUND)
        get_target_property(_p protobuf::protoc
                IMPORTED_LOCATION)
        message(STATUS "[ ${CMAKE_CURRENT_LIST_FILE}:${CMAKE_CURRENT_LIST_LINE} ] "
                "target=protobuf::protoc location=${_loc}")
        foreach (_target protobuf::libprotobuf protobuf::libprotobuf-lite)
            get_target_property(_p ${_target}
                    INTERFACE_LINK_LIBRARIES)
            message(STATUS "[ ${CMAKE_CURRENT_LIST_FILE}:${CMAKE_CURRENT_LIST_LINE} ] "
                    "target=${_target} link_libraries=${_p}")
            get_target_property(_p ${_target}
                    INTERFACE_INCLUDE_DIRECTORIES)
            message(STATUS "[ ${CMAKE_CURRENT_LIST_FILE}:${CMAKE_CURRENT_LIST_LINE} ] "
                    "target=${_target} include_directories=${_p}")
        endforeach ()
        unset(_target)
        unset(_p)
    endif ()
